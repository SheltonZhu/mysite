...
type HeartbeatServiceClient interface {
	Heartbeat(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StringValue, error)
}
...
func (c *heartbeatServiceClient) Heartbeat(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StringValue, error) {
	out := new(StringValue)
	err := c.cc.Invoke(ctx, "/protos.HeartbeatService/Heartbeat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HeartbeatServiceServer interface {
	Heartbeat(context.Context, *Empty) (*StringValue, error)
...
func (UnimplementedHeartbeatServiceServer) Heartbeat(context.Context, *Empty) (*StringValue, error) {
...
func _HeartbeatService_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.HeartbeatService/Heartbeat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartbeatServiceServer).Heartbeat(ctx, req.(*Empty))
	}
...
var HeartbeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protos.HeartbeatService",
	...
	Metadata: "grpc/protos/heartbeat.proto",
}
